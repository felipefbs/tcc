...
\hypersetup{
  ...
  pdfkeywords={wisun}{iot}{wireless}{RSSF}{rádio}{trabalho acadêmico}, 
...
\newcommand{\refact}[1]{{\color{blue}[refatorar] #1}}
...
% \input{./sections/preTextual/catalog.tex}       % Ficha bibliográfica
...
\bibliography{./references.bib} % Referências bibliográficas
