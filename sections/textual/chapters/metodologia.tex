...
\begin{figure}[h]
  \centering
  \caption{Prédio dos Professores, Campus Campina Grande.}
...
\begin{table}[h!]
  ...
  \begin{tabular}{|c c c c|}
    ...
    \hline
  \end{tabular}
  \footnotetext{{\emph{Forward Error Correction}(Código de Correção de Erro)}}
  \label{table:config}
\end{table}
